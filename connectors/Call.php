...
class Call extends Zang_Related {
     ...
     *      @type string  $reqData['IfMachine'] [continue|Specifies how Avaya CPaaS should handle this call if it goes to voicemail. Allowed values are "continue" to proceed as normal, "redirect" to redirect the call to the ifMachineUrl, or "hangup" to hang up the call. Hangup occurs when the tone is played. IfMachine accuracy is around 90% and may not work in all countries.]
     *      @type string  $reqData['IfMachineUrl'] [The URL Avaya CPaaS will redirect to for instructions if a voicemail machine is detected while the IfMachine parameter is set to "redirect". Url length is limited to 200 characters.]
