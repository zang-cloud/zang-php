...
class IncomingPhoneNumbers extends Zang_Related {
     ...
     *      @type string $reqData['HeartbeatMethod'][POST|The HTTP method Zang will use when requesting the HeartbeatURL.]
     ...
     *      @type string $reqData['StatusCallbackMethod'][POST|The HTTP method Zang will use when requesting the HangupCallback URL.]
