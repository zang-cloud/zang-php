...
require_once '../../connectors/Conferences.php';
...
try {
    ...
    $conferences = Conferences::getInstance();
    ...
    $conferences -> setOptions(array(
        "account_sid"   => $_ENV["ACCOUNT_SID"],
        "auth_token"    => $_ENV["AUTH_TOKEN"],
    ));

    $conferenceResult = $conferences->playAudioToParticipant(array(
    ...
    echo "<pre>";
    print_r($conferenceResult->getResponse());
    echo "</pre>";
