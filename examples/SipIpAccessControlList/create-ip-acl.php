...
require_once '../../connectors/SipIpAccessControlList.php';
...
try {
    ...
    $sipIpAccessControlList = SipIpAccessControlList::getInstance();
    ...
    $result = $sipIpAccessControlList->createIPACL(array(
