...
require_once '../../connectors/AvailablePhoneNumbers.php';
...
try {
    ...
    $availablePhoneNumbers = AvailablePhoneNumbers::getInstance();
    ...
    $availablePhoneNumbers -> setOptions(array(
        "account_sid"   => $_ENV["ACCOUNT_SID"],
        "auth_token"    => $_ENV["AUTH_TOKEN"],
    ));

    $result = $availablePhoneNumbers->listAvailableNumbers(array(
        "Country"       => "US",
        "Type"          => "Local",
        "PageSize"      => "100"
    ));
