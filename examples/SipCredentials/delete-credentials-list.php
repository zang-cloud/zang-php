...
require_once '../../connectors/SipCredentials.php';
...
try {
    ...
    $sipCredentials = SipCredentials::getInstance();
    ...
    $sipCredentials -> setOptions(array(
        "account_sid"   => $_ENV["ACCOUNT_SID"],
        "auth_token"    => $_ENV["AUTH_TOKEN"],
    ));

    $result = $sipCredentials->deleteCredentialsList(array(
        "CLSid" => "{CLSid}"
    ));
