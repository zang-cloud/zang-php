...
require_once '../../connectors/Transcriptions.php';
...
try {
    ...
    $transcriptions = Transcriptions::getInstance();
    ...
    $transcriptions -> setOptions(array(
        "account_sid"   => $_ENV["ACCOUNT_SID"],
        "auth_token"    => $_ENV["AUTH_TOKEN"],
    ));

    $result = $transcriptions->transcribeRecording(array(
