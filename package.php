...
$description = <<<DESC
Zang PHP wrapper is an open source tool built for easy access to the Zang.com API infrastructure. Zang is a powerful cloud communications API built to enable your apps to send and receive SMS messages and phone calls — all while controlling the call flow. Some features are conferencing, phone calls, text-to-speech, recordings, transcriptions and much more.
DESC;
...
$package->setChannel('pear.zang.com');
