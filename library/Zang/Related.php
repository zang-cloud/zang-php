...
/**
 *
 * Related logic to Zang wrapper. This file is the parent of "all"
 *
 * --------------------------------------------------------------------------------
 *
...
abstract class Zang_Related
{
    ...
    /** Wrapper to return Zang response as JSON */
    CONST WRAPPER_JSON         = 'json';


    /** Wrapper to return Zang response as XML */
    ...
    /**
     * Available Zang REST endpoint versions are:
     *
     * @var array
     */
    ...
    /**
     * All existing and available Zang components that can be accessed by
     * this wrapper
     *
     * @var array
     */
    ...
    /**
     * Set a single option for the Zang wrapper. If option key doesn't exist it will
    ...
    function setOption($key, $value) {
        if(!array_key_exists(strtolower($key), self::$_options)) {
            throw new Zang_Exception("Provided option '{$key}' cannot be found");
        }
     ...
     * so please consult REST documentation on the zang site.
     *
     * @param  string|array $component
     * @param  array        $data
     * @return Zang_Connector
    ...
    /**
     * Return an instance of the Zang Client class
     *
     * @return Class <Zang_Client, self, NULL>
     */
    function getClient() {
    	return Zang_Client::getInstance();
    }

    /**
     * Return an instance of the Zang Connect class
     *
     * @return Class <Zang_Connect, self, NULL>
     */
    function getConnect() {
    	return Zang_Connect::getInstance();
    }
    ...
    /**
     * Building base URL of Zang wrapper. This will set
    ...
    private function _buildBaseUrl() {
        ...
        if(is_null($this->option('account_sid'))) {
            throw new Zang_Exception(
                ...
                auth_token in order to authenticate and/or use Zang wrapper"
            );
        }
    ...
    /**
     * Get base version of the Zang REST API endpoint.
     *
     * @return string
     * @throws Zang_Exception  If invalid api_version applied
     */
    private function _getBaseVersion() {
        ...
        if(!in_array($base_version, $this->_availableVersions)) {
            ...
            throw new Zang_Exception("Defined version '{$base_version}' does not exist. Please use one of following versions: '{$base_versions}'");
        }
    ...
    /**
     * This will build URL of Zang wrapper after the AccountSid with or without
    ...
    private function _buildUrl($component, Array $parameters=array()) {
        ...
        if(is_array($component)) {
            ...
            if(is_null($schemas->getRestComponentName(strtolower($component[0])))) {
                throw new Zang_Exception("First resource argument in array cannot be null!");
            }
