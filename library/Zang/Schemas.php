...
/**
 *
 * Zang Schemas file. With this file schemas/zang.json will be imported
 *
 * --------------------------------------------------------------------------------
 *
...
class Zang_Schemas
{
    ...
    /** Default location of the zang.json schema file  */
    CONST ZANG_SCHEMA_FILE = '/schemas/zang.json';

    /**
     * Storage of zang.json schema data
     *
     * @var array|null
     */
    ...
    /**
     * This method will load internal zang.json schema in case it's not being loaded
     *
    ...
    public function loadSchema() {
        if(is_null(self::$_schemaData)) {
            ...
            if (!empty($error)) throw new Zang_Exception('JSON SCHEMA Error: '.$error);
    ...
    /**
     * Is current component name part of Zang REST API
     *
    ...
    /**
     * Converts a short name to a relative Zang REST API URI
    ...
    /**
     * Get all available Zang REST API components
     *
